package com.jp.genesis.integration;
...
import com.jp.genesis.IntegrationTest;
...
public class EmployeeIntegrationTest extends IntegrationTest {
	...
	public void testEmployeeByIdWithResponseEntitySuccess() throws Exception {
		...
		ResponseEntity<String> response = this.getRestTemplate().exchange(this.constructURL("/jp/genesis/employees/10010"),
		...
		// Fetch specific Json node values from Json string and compare it
...
//		String expected1 = "{\"birth_date\":\"1963-05-31T18:30:00.000+00:00\",\"first_name\":\"Duangkaew\",\"last_name\":\"Piveteau\",\"gender\":\"F\",\"hire_date\":\"1989-08-23T18:30:00.000+00:00\"}";
	...
	public void testEmployeeByIdWithObjectSuccess() throws Exception {
		Employee employee = this.getRestTemplate().getForObject(this.constructURL("/jp/genesis/employees/10010"),Employee.class);
	...
	public void getEmployeeByIdNotFoundSuccess() throws Exception {
		...
		ResponseEntity<String> response = this.getRestTemplate().exchange(this.constructURL("/jp/genesis/employees/999999999"),
				HttpMethod.GET, entity, String.class);
	...
	public void testSaveNewEmployeeResponseEntitySuccess() throws Exception {
        ...
        ResponseEntity<String> response = this.getRestTemplate().postForEntity(this.constructURL("/jp/genesis/employees"), request, String.class);
	...
	public void healthCheckShouldReturnDefaultMessage() throws Exception {
		...
		String response = this.getRestTemplate().getForObject(this.constructURL("/jp/genesis/healthcheck"),String.class);
